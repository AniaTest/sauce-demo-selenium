...
describe("Cart page scenarios", function(){
    ...
    describe("adding products to a cart", function() {
        ...
        it("checks if product listed in the cart can be opened", async function() {
        ...
        it("checks if product listed in the cart can be removed", async function() {
            await cartPage.clickRemoveButton();
            const isItemNotFoundInCart = await cartPage.isItemNotFoundInCart()

            assert(true, isItemNotFoundInCart)
        });
    });
});
