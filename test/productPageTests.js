...
describe('Product page scenarios', function(){
    ...
    describe('sorting products', function() {
        ...
        it('sort products by name from a-z', async function() {
        ...
        it('sort products by name from z-a', async function() {
        ...
        it('sort products by price from ascending', async function() {
        ...
        it('sort products by price from descending', async function() {
    ...
    describe('open menu', function() {
        ...
        it('click on menu and check if it opens and closes', async function() {
            await productPage.clickOnMenuButton();
            const menuDisplayed = await productPage.getMenuWrapperState()

            assert.equal( menuDisplayed, false);
            
            await productPage.clickCloseMenuButton();
            const menuHidden = await productPage.getMenuWrapperState();
